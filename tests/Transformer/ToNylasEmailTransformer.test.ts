...
import { type TypeNylasEmail } from '../../src/Type/NylasMessage';

describe('ToNylasEmailTransformer', () =>
{
	...
	it('should correctly transform a valid TypeEmailMessage object to a TypeNylasEmail object', () =>
	{
		const input: TypeEmailMessage = {
			...
			attachments: [
				{ path: '/path/to/file.pdf', contentDisposition: 'attachment', filename: 'file.pdf', content: 'SGVsbG8gd29ybGQ=' }
			],
			date: 1723401655
		};
